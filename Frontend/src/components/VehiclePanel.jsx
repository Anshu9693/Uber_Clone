    ...
    return (
        <div>
            ...
            <div onClick={()=>{
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare?.car ? props.fare.car : 0}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare?.bike ? props.fare.bike : 0}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare?.auto ? props.fare.auto : 0}</h2>
            </div>
        </div>
    )
}
